...
export class ImageTable21660462611795 implements MigrationInterface {
  name = 'ImageTable21660462611795';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE \`image\` ADD \`workoutId\` int NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`image\` DROP COLUMN \`workoutId\``);
    await queryRunner.query(
