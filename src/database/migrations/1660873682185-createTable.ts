...
export class createTable1660873682185 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    // );
    // await queryRunner.query(
    //   `CREATE TABLE \`spa\` (\`id\` int NOT NULL AUTO_INCREMENT, \`spa_name\` varchar(255) NOT NULL, \`spa_description\` varchar(255) NOT NULL, \`hotelId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    // );
    // await queryRunner.query(
    //   `CREATE TABLE \`treatment\` (\`id\` int NOT NULL AUTO_INCREMENT, \`treatment_name\` varchar(255) NOT NULL, \`treatment_description\` varchar(255) NOT NULL, \`treatment_price\` int NOT NULL, \`spaId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    // );
    // await queryRunner.query(
    ...
    // );
    // await queryRunner.query(
    //   `CREATE TABLE \`image\` (\`id\` int NOT NULL AUTO_INCREMENT, \`image_url\` varchar(255) NOT NULL, \`hotelId\` int NULL, \`spaId\` int NULL, \`treatmentId\` int NULL, \`restaurantId\` int NULL, \`dishId\` int NULL, \`gymId\` int NULL, \`workoutId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    // );
    // await queryRunner.query(
    ...
    // );
    // await queryRunner.query(
    //   `CREATE TABLE \`hotel\` (\`id\` int NOT NULL AUTO_INCREMENT, \`hotel_name\` varchar(255) NOT NULL, \`hotel_email\` varchar(255) NOT NULL, \`hotel_address\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    // );
    // await queryRunner.query(
    //   `CREATE TABLE \`qrcode\` (\`id\` int NOT NULL AUTO_INCREMENT, \`qr_link\` text NOT NULL, \`hotelId\` int NULL,  INDEX \`REL_b94610e1c57e1b49a9753272f4\` (\`hotelId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    // );
    // await queryRunner.query(
    ...
    // );
    // await queryRunner.query(
    //   `ALTER TABLE \`image\` ADD CONSTRAINT \`FK_2420fe1ea864ea120915bf8b6c7\` FOREIGN KEY (\`hotelId\`) REFERENCES \`hotel\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    // );
    // await queryRunner.query(
    //   `ALTER TABLE \`image\` ADD CONSTRAINT \`FK_2e48cd56dd579c67323eee2fa63\` FOREIGN KEY (\`spaId\`) REFERENCES \`spa\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    // );
    // await queryRunner.query(
    //   `ALTER TABLE \`image\` ADD CONSTRAINT \`FK_25161948f47cc6a6bd4b7b7b6dd\` FOREIGN KEY (\`treatmentId\`) REFERENCES \`treatment\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    // );
    // await queryRunner.query(
    //   `ALTER TABLE \`image\` ADD CONSTRAINT \`FK_2c72d96b924267a86fbc5f78cce\` FOREIGN KEY (\`restaurantId\`) REFERENCES \`restaurant\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    // );
    // await queryRunner.query(
    ...
    // );
    // await queryRunner.query(
    //   `ALTER TABLE \`image\` ADD CONSTRAINT \`FK_d2a15fa7c1c28d5a5b584c54ccf\` FOREIGN KEY (\`gymId\`) REFERENCES \`gym\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    // );
    // await queryRunner.query(
    //   `ALTER TABLE \`image\` ADD CONSTRAINT \`FK_509d0e9a21d56a7ecae5cf5fc35\` FOREIGN KEY (\`workoutId\`) REFERENCES \`workout\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`,
    // );
    // await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`image\` DROP FOREIGN KEY \`FK_509d0e9a21d56a7ecae5cf5fc35\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`image\` DROP FOREIGN KEY \`FK_d2a15fa7c1c28d5a5b584c54ccf\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`image\` DROP FOREIGN KEY \`FK_957641b298c67cc692d1f69884a\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`image\` DROP FOREIGN KEY \`FK_2c72d96b924267a86fbc5f78cce\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`image\` DROP FOREIGN KEY \`FK_25161948f47cc6a6bd4b7b7b6dd\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`image\` DROP FOREIGN KEY \`FK_2e48cd56dd579c67323eee2fa63\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`image\` DROP FOREIGN KEY \`FK_2420fe1ea864ea120915bf8b6c7\``,
    );
    await queryRunner.query(
