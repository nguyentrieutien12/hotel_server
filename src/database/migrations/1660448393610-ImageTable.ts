...
export class ImageTable1660448393610 implements MigrationInterface {
  name = 'ImageTable1660448393610';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE \`image\` ADD \`gymId\` int NULL`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`image\` DROP COLUMN \`gymId\``);
    await queryRunner.query(
