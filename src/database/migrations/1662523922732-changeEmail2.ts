...
export class changeEmail21662523922732 implements MigrationInterface {
    name = 'changeEmail21662523922732'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`order\` ADD CONSTRAINT \`FK_977a720b2e5040835dfa5a12284\` FOREIGN KEY (\`dishId\`) REFERENCES \`treatment\`(\`id\`) ON DELETE CASCADE ON UPDATE CASCADE`);
