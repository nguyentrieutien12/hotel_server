...
export class addColumnToImageTable1660208515254 implements MigrationInterface {
    name = 'addColumnToImageTable1660208515254'

    public async up(queryRunner: QueryRunner): Promise<void> {
  
        await queryRunner.query(`ALTER TABLE \`image\` ADD \`treatmentId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`image\` DROP COLUMN \`treatmentId\``);
