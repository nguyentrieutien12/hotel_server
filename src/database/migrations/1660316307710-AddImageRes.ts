...
export class AddImageRes1660316307710 implements MigrationInterface {
    name = 'AddImageRes1660316307710'

    public async up(queryRunner: QueryRunner): Promise<void> {
     
        await queryRunner.query(`ALTER TABLE \`image\` ADD \`restaurantId\` int NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`image\` DROP COLUMN \`restaurantId\``);
