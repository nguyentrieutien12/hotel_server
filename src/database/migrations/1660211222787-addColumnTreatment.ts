...
export class addColumnTreatment1660211222787 implements MigrationInterface {
  name = 'addColumnTreatment1660211222787';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE \`treatment\` DROP COLUMN \`treament_name\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`treatment\` DROP COLUMN \`treament_description\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`treatment\` DROP COLUMN \`treament_price\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`treatment\` ADD \`treatment_name\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`treatment\` ADD \`treatment_description\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`treatment\` ADD \`treatment_price\` int NOT NULL`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`treatment\` DROP COLUMN \`treatment_price\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`treatment\` DROP COLUMN \`treatment_description\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`treatment\` DROP COLUMN \`treatment_name\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`treatment\` ADD \`treament_price\` int NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`treatment\` ADD \`treament_description\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE \`treatment\` ADD \`treament_name\` varchar(255) NOT NULL`,
    );
    await queryRunner.query(
